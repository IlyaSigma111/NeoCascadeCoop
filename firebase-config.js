...
import { getDatabase, ref, set, get, update, onValue, push, remove, onChildAdded, onChildChanged } from "https://www.gstatic.com/firebasejs/9.15.0/firebase-database.js";
...
export { auth, database, provider, signInWithPopup, signOut, onAuthStateChanged, ref, set, get, update, onValue, push, remove, onChildAdded, onChildChanged };
